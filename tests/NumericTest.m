...
%&           '../models/R2016b/driveline_springdamper_clutchU'};
%'../models/R2016b/driveline_springdamper_delay'};
           %}; 
      
            %'../models/R2016b/driveline_springdamper_clutch'};% needs
         %advanced index reduction
      %'../models/R2016b/driveline_springdamper_clutchU'};% needs 
       %'../models/R2016b/driveline_springdamper_clutchL'};% needs  advanced index reduction
         % %'../models/R2016b/driveline_springdamper_clutch'};%,...
          %'../models/R2016b/proprietary/FM/DCT_v_0_1'};%,...
%'../models/proprietary/R2016b/FM/smallDrivelineSimScape_oscSpring_flex_backlash'};%,...
%'../models/proprietary/R2016b/PMA/ComplexDriveline_Example'};
